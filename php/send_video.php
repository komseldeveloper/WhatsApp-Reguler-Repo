<?php
	...
	$content = json_encode(
          array(
              "message_type" => "whatsapp:media:video",
              ...
              "text" => "Halo Dunia Dari Whatsapp API", // Isi Pesan (Cption Dari Pesan Video)
              ...
              "delay"  =>  1,
              "media_path" =>  "http://contoh.con/contoh.mp4" // LInk video harus bisa diakses secara public
          )
      );
